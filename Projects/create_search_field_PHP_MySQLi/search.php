    ...
    <div class="article-container">
      <?php
        if (isset($_POST['submit'])) {
          ...
          //Here we use the keyword "LIKE" in our query and we wrap the $search variable in "%", instead of setting the
          //column name equal to our variable like we usually do. This is because we need to check if the keyword matches
          //PART of the database data, and isn't 100% identical to the data.
